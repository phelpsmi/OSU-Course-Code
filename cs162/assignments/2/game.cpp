 ...
 ** Post-Conditions: none
 *********************************************************************/
bool game::queryPlayer(int cardNum, int taker, int giver){
	bool hadCard = false;
	for (int x = 0; x < 4; ++x){
